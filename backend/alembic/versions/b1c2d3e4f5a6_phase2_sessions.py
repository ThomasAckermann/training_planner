...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('age_range', PgEnum('U12', 'U14', 'U16', 'U18', 'ADULTS', 'ALL', name='agerange', create_type=False), nullable=True),
        sa.Column('skill_level', PgEnum('BEGINNER', 'INTERMEDIATE', 'ADVANCED', 'ELITE', name='skilllevel', create_type=False), nullable=True),
