...
import { useCreateModule } from "../hooks/useModules.js";
...
const schema = z.object({
  ...
  phase_type: z.enum(["WARMUP", "MAIN", "GAME", "COOLDOWN"], {
    required_error: "Phase type is required",
  }),
...
export default function ModuleNew() {
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      <div className="mb-8">
        ...
        <p style={{ color: "var(--color-text-muted)" }}>
          Create a reusable phase block with an ordered list of drills.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Card>
          ...
          <div className="space-y-4">
            <Input
              label="Title *"
              placeholder="e.g. 15-min Reception Warm-up"
        ...
        <Card>
          ...
          {selectedDrills.length === 0 ? (
            ...
            >
              No drills added yet. Search and add drills below.
            </p>
          ) : (
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <div className="flex gap-3">
            ...
            <Button
              type="submit"
              variant="primary"
              loading={isSubmitting || createModule.isPending}
            >
              Create Module
            </Button>
          </div>
