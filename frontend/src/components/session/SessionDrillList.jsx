...
import { useReorderSessionDrills, useRemoveDrillFromSession, useUpdateDrillInSession } from '../../hooks/useSessions.js'
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {drill.drawing_thumb_url && (
          <div className="mb-1.5 rounded overflow-hidden" style={{ border: '1px solid var(--color-border)', maxWidth: 240 }}>
            <img src={drill.drawing_thumb_url} alt="Tactical diagram" className="w-full block" />
          </div>
        )}
        ...
        <div className="flex items-center gap-2 text-xs" style={{ color: 'var(--color-text-muted)' }}>
          {isOwner && editingDuration ? (
            ...
            <button
              className={`flex items-center gap-1 ${isOwner ? 'hover:underline cursor-pointer' : ''}`}
              ...
              {effectiveDuration != null ? (
                <>
                  {drill.duration_override != null && (
                    <Pencil className="w-3 h-3" style={{ color: 'var(--color-accent)' }} />
                  )}
...
export default function SessionDrillList({ drills = [], sessionId, isOwner = false }) {
  const navigate = useNavigate()
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs mb-2" style={{ color: 'var(--color-text-muted)' }}>
                  ...
                  {drill.num_players_min != null && (
                    <span className="ml-3">
                      ...
                      {drill.num_players_max && drill.num_players_max !== drill.num_players_min
                ...
                {drill.drawing_thumb_url && (
                  <div className="mb-2 rounded overflow-hidden" style={{ border: '1px solid var(--color-border)', maxWidth: 320 }}>
                    <img
