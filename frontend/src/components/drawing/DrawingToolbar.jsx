...
export default function DrawingToolbar({ stageRef, onSave, isSaving, saveLabel }) {
  const { past, future, selectedId, undo, redo, removeIcon, removeArrow, getDrawingJson } =
    useDrawingStore()
  ...
  return (
    ...
    >
      ...
      <div style={{ width: 1, height: 20, backgroundColor: 'var(--color-border)', margin: '0 2px' }} />
